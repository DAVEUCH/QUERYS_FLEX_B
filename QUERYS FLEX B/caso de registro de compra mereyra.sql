...
SELECT *FROM Cp 
WHERE NumCp='E001-0001126' AND PKID=2903619
...
update Cp set
IDMoneda=1
--FechaEmision='2024-27-12',
--Hora='2024-27-12 16:16',
--FechaTipoCambio='2024-27-12',
--TipoCambio='3.748'
where NumCp='E001-0001126' AND PKID=2903619
...
SELECT *FROM Cp 
WHERE NumCp='F001-0025642' AND PKID=2889484
