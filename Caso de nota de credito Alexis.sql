...
select*from Cp where NumCp='E001-0000003' AND PKID=862087
--SELECT*FROM Cp WHERE PKID=833277

select *from CpCobrarPagar where PKID in (828566,842796)
select *from CpCobrarPagar where PKID=862087


update CpCobrarPagar set MovSaldo=1 where PKID=862087