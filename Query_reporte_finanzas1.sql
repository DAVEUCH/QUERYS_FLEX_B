...
FROM            dbo.Persona INNER JOIN
                         ...
                         dbo.CGI_ConsultaComisionesDocumento2('2024-06	-01', '2024-06-05') AS CGI_ConsultaComisionesDocumento_1 ON dbo.Cp.PKID = CGI_ConsultaComisionesDocumento_1.IDCp INNER JOIN
