...
select top(10)*from Cp where NumCp in('F001-0028584')

select top(10)*from Cp where NumCp in('118-2025-10-175544','235-2025-10-071242')--56/100000014
select*from CpCobrarPagar where PKID in (856072)
...
FechaPago='21-07-2025',FechaVencimiento='21-07-2025',FechaProgramacionPago='21-07-2025'
where PKID in (856573)
